function extractCUDepthGrndTruthCPIH
    ...
    % After executing this program, for each video at each QP, 12 sample files ended with "_CUXXSamples.dat" 
    ...
    filePathInput='G:\YUV_All\';
    filePathExtract='F:\YUV_All_Extract\';
    % In yuvNameList, uncomment some video name(s).
    yuvNameList={...
...
function nSamplesMatrix=extractCUDepthGrndTruth(...
    ...
    fileNameCUDepthIndex=getFilePathAndName(filePathInput,[yuvName '_qp' num2str(QP)],'_Index.dat');
    fileNameCUDepth=getFilePathAndName(filePathInput,[yuvName '_qp' num2str(QP)],'_CUDepth.dat');
